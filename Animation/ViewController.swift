...
class ViewController: NSViewController {
    ...
    @IBOutlet var myView: NSViewForAnimation!
    ...
    override func viewDidLoad() {
        ...
        // Change size of the view to match canvas size
        self.view.setFrameSize(NSSize(width: sketch.canvas.width, height: sketch.canvas.height))
